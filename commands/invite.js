...
module.exports.run = async (_, message, __) => {
	try {
		const helpEmbed = new Discord.MessageEmbed()
			...
			.addFields(
				{ name: '<:BanHammer:785963830697263185> Invite Me', value: '[Click Here to Invite Me](https://discord.com/oauth2/authorize?client_id=784109092330799124&permissions=8&scope=bot)', inline: true },
